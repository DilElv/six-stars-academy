        ...
        <>
          <div className="grid lg:grid-cols-[auto_1fr] gap-5 items-start">
            <div className="glass-card rounded-3xl p-4 sm:p-6">
              <div className="flex items-center gap-1.5 text-sm font-semibold text-navy-900 mb-3 px-1">
              ...
              />
              <div className="flex flex-col gap-1.5 px-1 pt-3 text-xs text-gray-400">
            ...
            <div className="glass-card rounded-3xl p-4 min-h-[240px]">
              {selectedSchedule ? (
                <>
